...
function Clients(props) {
    ...
    function handleCreate() {
        ...
        axios
            ...
            .post("https://localhost:5000/clients", newClient)
    ...
    useEffect(() => {
        ...
        if(updateClient.companyName !== ""){
            ...
            .put("https://localhost:5000/clients", updateClient)
    ...
    function handleDelete(event){
        ...
        axios
            .delete("https://localhost:5000/clients", {data: {id: targetID}})
            .then(res => {
                var updatedClients = [];
                clients.filter(client => {
    ...
    return(
        <div className={`Clients ${props.mainContainerClass}`}>
